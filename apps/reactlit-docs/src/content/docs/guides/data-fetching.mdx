...
<Code
  ...
  ins={[
    { range: '30-31' },
    { range: '39-41', label: 'fetcher' },
    { range: '42-45', label: 'show loading' },
    { range: '46-48', label: 'get data' },
    { range: '53-56' },
    { range: '57-58', label: 'refetch' },
    { range: '92-99', label: 'update' },
    { range: '102-103', label: 'disable' },
  ]}
/>
